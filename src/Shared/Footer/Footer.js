...
const Footer = () => {
  return (
    <div className="bg-white">
      <footer className="footer footer1 p-10 text-base-content">
        <div className="m-auto ">
          <span className="footer-title font-bold ">Services</span>
          <Link className="link link-hover font-bold font-mono">Branding</Link>
          <Link className="link link-hover font-bold font-mono">Design</Link>
          <Link className="link link-hover font-bold font-mono">Marketing</Link>
        ...
        <div className="m-auto ">
          ...
          <Link to="/contact" className="link link-hover font-bold font-mono">
            Contact
          </Link>
      ...
      <footer className="footer footer2  px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div>
        ...
        <div className="m-auto copyright font-bold font-mono">
